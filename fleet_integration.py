...
import sys
import os
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', 'flux-lcar-cartridge'))
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', 'flux-lcar-scheduler'))

from bridge import CartridgeBridge, Scene
from scheduler import FleetScheduler, ModelTier
