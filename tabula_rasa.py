...
class PermissionLevel:
    ...
    LEVELS = {
        ...
        1: {  # Crew
            "title": "Crew",
            "can": ["look", "go", "say", "tell", "help", "who", "inventory", "read",
                    "yell", "gossip", "write_note", "use_room",
                    "check_mail", "send_mail", "equip", "quests"],
        ...
        2: {  # Specialist
            ...
            "can": ["look", "go", "say", "tell", "help", "who", "inventory", "read",
                    "yell", "gossip", "write_note", "use_room",
                    "check_mail", "send_mail", "equip", "quests",
                    "build_room", "create_item", "use_equipment",
        ...
        3: {  # Captain
            ...
            "can": ["look", "go", "say", "tell", "help", "who", "inventory", "read",
                    ...
                    "build_room", "create_item", "use_equipment",
                    "cast_spell", "summon_npc", "dismiss_npc", "join_channel",
                    "build_area", "create_adventure", "edit_own_rooms", "create_spell",
        ...
        4: {  # Cocapn
            ...
            "can": ["look", "go", "say", "tell", "help", "who", "inventory", "read",
                    ...
                    "build_area", "create_adventure", "edit_own_rooms", "create_spell",
                    "assign_quests", "review_agent", "manage_vessel", "back_channel",
                    "edit_any_room", "create_item_type", "create_room_type",
...
class ToolRoom:
    ...
    def use_command(self, command: str, agent: str, args: str = "", agent_level: int = 0) -> dict:
        ...
        if cmd.get("min_level", 0) > agent_level:
            return {"error": f"Command '{command}' requires level {cmd['min_level']} (you are level {agent_level})."}
